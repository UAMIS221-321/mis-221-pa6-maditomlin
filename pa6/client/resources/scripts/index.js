...
function handleEditClick(){
    ...
    document.getElementsById("saveButton").style.display = "inline-block";
}
...
function hideButtons(){
    ...
    document.getElementById("editButtom").style.display = "none";
    document.getElementById("deleteRuttom").style.display = "none";
    document.getElementById("rentButtom").style.display = "none";
    document.getElementById("returnButton").style.display = "none";
}

function showButtons(){
    document.getElementById("newButtom").style.display = "inline-block";
    document.getElementById("editButtom").style.display = "inline-block";
    document.getElementById("deleteRuttom").style.display = "inline-block";
    document.getElementById("rentButtom").style.display = "inline-block";
